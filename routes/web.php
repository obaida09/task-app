...
{
    // Route::get('sockets/serve', function(){ \Illuminate\Support\Facades\Artisan::call('websockets:serve'); });
    ...
    Route::get('session-details/pdf/{id}' , [SessionDetailsController::class  , 'pdf'])->name('session_details_pdf');
