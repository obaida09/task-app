                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    <input id="name" type="text"
                                        ...
                                        name="regeneration_trigger" value="{{ old('regeneration_trigger') }}" required
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    <input id="name" type="text"
                                        class="form-control @error('name') is-invalid @enderror"
                                        name="regeneration_symptoms_a" value="{{ old('regeneration_symptoms_a') }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    <input id="name" type="text"
                                        class="form-control @error('name') is-invalid @enderror"
                                        name="regeneration_symptoms_b" value="{{ old('regeneration_symptoms_b') }}"
                                        required autocomplete="name" autofocus>
                                </div>
